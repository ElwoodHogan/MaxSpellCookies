Game.registerMod('leon',{
				...
				addIntro:function(text){
					...
					if (!l('bakerySubtitle2')) l('bakeryName2').insertAdjacentHTML('afterend','<div id="bakerySubtitle2" class="title" style="text-align:center;position:absolute;left:0px;right:0px;bottom:64px;font-size:15px;pointer-events:none;text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;opacity:1;"></div>');
					l('bakerySubtitle2').textContent=Game.prestige+' '+added;
				},
			});
